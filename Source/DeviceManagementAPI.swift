...
open class DeviceManagementAPI {
    ...
    class func writeServerProperties(did: String, properties: [String:Any]) -> Promise<Void> {
        let promise = Promise<Void>.pending()
        let path = ArtikCloudSwiftSettings.basePath + "/devicemgmt/devices/\(did)/serverproperties"
        
        APIHelpers.makeRequest(url: path, method: .post, parameters: properties, encoding: JSONEncoding.default).then { _ -> Void in
            promise.fulfill(())
        }.catch { error -> Void in
    ...
    /// - Returns: A `Promise<Void>`.
    class func deleteServerProperties(did: String) -> Promise<Void> {
        let promise = Promise<Void>.pending()
        let path = ArtikCloudSwiftSettings.basePath + "/devicemgmt/devices/\(did)/serverproperties"
    ...
    class func readProperties(did: String, includeTimestamp: Bool = false) -> Promise<DeviceManagementProperties> {
        let promise = Promise<DeviceManagementProperties>.pending()
    ...
    class func readProperties(dtid: String, count: Int, offset: Int = 0, filter: [String]? = nil) -> Promise<Page<DeviceManagementProperties>> {
        let promise = Promise<Page<DeviceManagementProperties>>.pending()
    ...
    ///   - filter: (Optional) An Array of "key=value" pairs used to filter results. Nested JSON objects are separated with dot notation.
    /// - Returns: A `Promise<Page<DeviceManagementProperties>>`.
    class func readProperties(dtid: String, filter: [String]? = nil) -> Promise<Page<DeviceManagementProperties>> {
    ...
    class func getDeviceTypeConfiguration(dtid: String) -> Promise<DeviceTypeConfiguration> {
        let promise = Promise<DeviceTypeConfiguration>.pending()
    ...
    /// - Returns: A `Promise<DeviceTypeConfiguration>`.
    class func setDeviceTypeConfiguration(dtid: String, devicePropertiesEnabled: Bool? = nil, pmin: Int64? = nil, pmax: Int64? = nil, taskExpiresAfter: Int64? = nil) -> Promise<DeviceTypeConfiguration> {
        let promise = Promise<DeviceTypeConfiguration>.pending()
        let path = ArtikCloudSwiftSettings.basePath + "/devicemgmt/devicetypes/\(dtid)"
        ...
        if let pmin = pmin {
            guard pmin >= 60, pmin <= 3600 else {
                promise.reject(ArtikError.deviceManagement(reason: .invalidPmin))
                return promise.promise
            }
        ...
        if let pmax = pmax {
            guard pmax >= 3600, pmax <= 86400 else {
                promise.reject(ArtikError.deviceManagement(reason: .invalidPmax))
                return promise.promise
            }
        ...
        if let taskExpiresAfter = taskExpiresAfter {
            guard taskExpiresAfter >= 60, taskExpiresAfter <= 604800 else {
                promise.reject(ArtikError.deviceManagement(reason: .invalidTaskExpiresAfter))
                return promise.promise
            }
            parameters["taskExpiresAfter"] = taskExpiresAfter
        }
        guard parameters.count > 0 else {
            getDeviceTypeConfiguration(dtid: dtid).then { result -> Void in
    ...
    class func createTask(dtid: String, filter: [String]? = nil, type: DeviceManagementTask.TaskType, property: String, parameters: [String:Any]? = nil) -> Promise<DeviceManagementTask> {
    ...
    ///   - parameters: (Optional) JSON object containing additional parameters for the task.
    /// - Returns: A `Promise<DeviceManagementTask>`.
    class func createTask(dtid: String, dids: [String], type: DeviceManagementTask.TaskType, property: String, parameters: [String:Any]? = nil) -> Promise<DeviceManagementTask> {
    ...
    /// - Returns: A `Promise<DeviceManagementTask>`.
    class func getTask(id: String) -> Promise<DeviceManagementTask> {
        let promise = Promise<DeviceManagementTask>.pending()
    ...
    class func getTasks(dtid: String, count: Int, offset: Int = 0, status: DeviceManagementTask.TaskStatus? = nil) -> Promise<DeviceManagementTaskPage> {
        let promise = Promise<DeviceManagementTaskPage>.pending()
    ...
    ///   - status: (Optional) The tasks' status.
    /// - Returns: A `Promise<DeviceManagementTaskPage>`.
    class func getTasks(dtid: String, status: DeviceManagementTask.TaskStatus? = nil) -> Promise<DeviceManagementTaskPage> {
    ...
    class func getTasks(did: String, count: Int, offset: Int = 0, status: DeviceManagementDeviceTaskState.TaskStatus? = nil) -> Promise<Page<DeviceManagementTask>> {
        let promise = Promise<Page<DeviceManagementTask>>.pending()
    ...
    ///   - status: (Optional) The device tasks' status.
    /// - Returns: A `Promise<Page<DeviceManagementTask>>`.
    class func getTasks(did: String, status: DeviceManagementDeviceTaskState.TaskStatus? = nil) -> Promise<Page<DeviceManagementTask>> {
    ...
    class func getDeviceTaskStatuses(id: String, count: Int, offset: Int = 0, dids: [String]? = nil, status: DeviceManagementDeviceTaskState.TaskStatus? = nil) -> Promise<Page<DeviceManagementDeviceTaskState>> {
        let promise = Promise<Page<DeviceManagementDeviceTaskState>>.pending()
    ...
    ///   - status: (Optional) Task status used to filter results.
    /// - Returns: A `Promise<Page<DeviceManagementDeviceTaskState>>`.
    class func getDeviceTaskStatuses(id: String, dids: [String]? = nil, status: DeviceManagementDeviceTaskState.TaskStatus? = nil) -> Promise<Page<DeviceManagementDeviceTaskState>> {
    ...
    class func getTaskStatusHistory(id: String) -> Promise<[DeviceManagementTask.TaskState]> {
        let promise = Promise<[DeviceManagementTask.TaskState]>.pending()
        let path = ArtikCloudSwiftSettings.basePath + "/devicemgmt/tasks/\(id)/statuses/history"
        
        APIHelpers.makeRequest(url: path, method: .get, parameters: nil, encoding: URLEncoding.queryString).then { response -> Void in
    ...
    class func getDeviceTaskStatusHistory(id: String, did: String) -> Promise<[DeviceManagementDeviceTaskState]> {
        let promise = Promise<[DeviceManagementDeviceTaskState]>.pending()
        let path = ArtikCloudSwiftSettings.basePath + "/devicemgmt/tasks/\(id)/statuses/history"
        let parameters = [
            "did": did
        ]
    ...
    /// - Parameter id: The Task's ID.
    /// - Returns: A `Promise<DeviceManagementTask>`.
    class func cancelTask(id: String) -> Promise<DeviceManagementTask> {
        let promise = Promise<DeviceManagementTask>.pending()
        let path = ArtikCloudSwiftSettings.basePath + "/devicemgmt/tasks/\(id)"
        
        APIHelpers.makeRequest(url: path, method: .put, parameters: ["status": DeviceManagementTask.TaskStatus.cancelled.rawValue], encoding: JSONEncoding.default).then { response -> Void in
            if let data = response["data"] as? [String:Any], let task = DeviceManagementTask(JSON: data) {
                promise.fulfill(task)
            } else {
                promise.reject(ArtikError.json(reason: .unexpectedFormat))
    ...
    ///   - did: The Device's ID.
    /// - Returns: A `Promise<DeviceManagementDeviceTaskState>`.
    class func cancelDeviceTask(id: String, did: String) -> Promise<DeviceManagementDeviceTaskState> {
        let promise = Promise<DeviceManagementDeviceTaskState>.pending()
        let path = ArtikCloudSwiftSettings.basePath + "/devicemgmt/tasks/\(id)/devices/\(did)"
        
        APIHelpers.makeRequest(url: path, method: .put, parameters: ["status": DeviceManagementDeviceTaskState.TaskStatus.cancelled.rawValue], encoding: JSONEncoding.default).then { response -> Void in
    ...
    fileprivate class func readPropertiesRecursive(_ container: Page<DeviceManagementProperties>, dtid: String, offset: Int = 0, filter: [String]? = nil) -> Promise<Page<DeviceManagementProperties>> {
        ...
        readProperties(dtid: dtid, count: 100, offset: offset, filter: filter).then { result -> Void in
            container.data.append(contentsOf: result.data)
            container.total = result.total
            
            if container.total > Int64(container.data.count) {
                self.readPropertiesRecursive(container, dtid: dtid, offset: Int(result.offset) + result.data.count, filter: filter).then { result -> Void in
                    promise.fulfill(result)
                }.catch { error -> Void in
                    promise.reject(error)
                }
    ...
    fileprivate class func getTasksRecursive(_ container: DeviceManagementTaskPage, dtid: String, offset: Int = 0, status: DeviceManagementTask.TaskStatus? = nil) -> Promise<DeviceManagementTaskPage> {
        ...
        getTasks(dtid: dtid, count: 100, offset: offset, status: status).then { result -> Void in
            container.data.append(contentsOf: result.data)
            container.total = result.total
            ...
            if container.total > Int64(container.data.count) {
                self.getTasksRecursive(container, dtid: dtid, offset: Int(result.offset) + result.data.count, status: status).then { result -> Void in
                    promise.fulfill(result)
                }.catch { error -> Void in
                    promise.reject(error)
                }
    ...
    fileprivate class func getDeviceTaskStatusesRecursive(_ container: Page<DeviceManagementDeviceTaskState>, id: String, offset: Int = 0, dids: [String]? = nil, status: DeviceManagementDeviceTaskState.TaskStatus? = nil) -> Promise<Page<DeviceManagementDeviceTaskState>> {
        ...
        getDeviceTaskStatuses(id: id, count: 100, offset: offset, dids: dids, status: status).then { result -> Void in
            container.data.append(contentsOf: result.data)
            container.total = result.total
            
            if container.total > Int64(container.data.count) {
                self.getDeviceTaskStatusesRecursive(container, id: id, offset: Int(result.offset) + result.data.count, dids: dids, status: status).then { result -> Void in
                    promise.fulfill(result)
                }.catch { error -> Void in
                    promise.reject(error)
                }
    ...
    fileprivate class func getTasksRecursive(_ container: Page<DeviceManagementTask>, did: String, offset: Int = 0, status: DeviceManagementDeviceTaskState.TaskStatus? = nil) -> Promise<Page<DeviceManagementTask>> {
        ...
        getTasks(did: did, count: 100, offset: offset, status: status).then { result -> Void in
            container.data.append(contentsOf: result.data)
            container.total = result.total
            
            if container.total > Int64(container.data.count) {
                self.getTasksRecursive(container, did: did, offset: Int(result.offset) + result.data.count, status: status).then { result -> Void in
                    promise.fulfill(result)
                }.catch { error -> Void in
                    promise.reject(error)
                }
